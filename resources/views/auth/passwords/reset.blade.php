        ...
        <div class="max-w-sm m-8">
            ...
            <form class="form-group" method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group">
                    <input
                        name="email" id="email" value="{{ old('email') ?? $email }}" required autocomplete="email"
                ...
                <div class="form-group">
                    <input
                        name="password" id="password" value="{{ old('password') }}" required autocomplete="new-password"
                        autofocus
                        class="form-control  @error('password') is-invalid @enderror text-grey-darker text-2xl
                        md:text-3xl font-light mb-8 leading-normal transparent-input"
                ...
                <div class="form-group">
                    <input
                        name="password_confirmation" id="password_confirmation" value="{{ old('password') }}" required
                        autocomplete="password_confirmation"
                        class="form-control  @error('password_confirmation') is-invalid @enderror text-grey-darker text-2xl
                        md:text-3xl font-light mb-8 leading-normal transparent-input"
