...
if [[ "$STAGED_FILES" = "" ]]; then
  echo "\033[42mNo files to watch\033[0m\n"
  exit 0
fi
...
if ! $PASS; then
  echo "\033[41mPHPCS FAILED:\033[0m Your commit contains files that should pass PHPCS but do not. Please fix the PHPCS errors and try again.\n"
  exit 1
else
  echo "\033[42mPHPCS SUCCEEDED\033[0m\n"
fi
