...
class CommentTest extends TestCase
{
    ...
    {
        Passport::actingAs($this->user);
        $post_resp = $this->post(route('storeCommentary', ['dashboard' => $this->dash->id, "post" => $this->post->id]),
            ['content' => str_random(10)]);
        $response = $this->delete(route('deleteCommentary', ['dashboard' => $this->dash->id, "post" => $this->post->id, 'commentary' => $post_resp->decodeResponseJson('id')]));
