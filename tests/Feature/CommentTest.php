...
class CommentTest extends TestCase
{
    ...
    {
        Passport::actingAs($this->user);
        $post_resp = $this->post(route('post_commentary', ['dashboard' => $this->dash->id, "post" => $this->post->id]),
            ['content' => str_random(10)]);
        $response = $this->delete(route('delete_commentary', ['dashboard' => $this->dash->id, "post" => $this->post->id, 'commentary' => $post_resp->decodeResponseJson('id')]));
