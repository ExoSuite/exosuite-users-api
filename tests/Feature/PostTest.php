...
class PostTest extends TestCase
{
    ...
    {
        Passport::actingAs($this->user);
        $post_response = $this->post(route('post_Post', ['dashboard' => $this->dashboard->id]), ['content' => str_random(10)]);
        $response = $this->delete(route('delete_Post', ['dashboard' => $this->dashboard->id, 'post' => $post_response->decodeResponseJson('id')]));
